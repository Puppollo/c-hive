...
const int world_MINERAL_RANDOM = 2 ;                // вероятность того что в клетке сгенерируется минерал
const int world_MINERAL_PARAM = 500 ;               // среднее значение параметра param[0] типа building_type_MINERAL
