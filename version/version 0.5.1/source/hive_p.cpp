...
const int sprite_BUTTONS_X_COUNT    =10 ;
...
void GameInit()
{
  ...
  world = new c_World(SpriteList->Find(sprite_BUILDINGS_ID),SpriteList->Find(sprite_PARTICICLE_ID),1,1) ;
...
void GameMain()
{
  ...
  //drawind
  res=world->Draw(player_ID,screen,DDraw->DDSBack) ;
