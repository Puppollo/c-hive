...
/////////////
const int building_terrain_MAX_DHEIGHT = 10 ;
/////////////
...
const int world_MINERAL_IN_RANDOM = 35 ;       // вероятность того что в жиле сгенерируеться минерал
...
const int world_CHANGE_CYCLE  = 10000 ; // значение TIME при которой сменяется цикл
const int world_CYCLE_MINERAL = 1 ;     // цикл во время которого образуются новые минералы
/////////////
const int terrain_LANDSCAPE_RANDOM = 15 ; // вероятность создания впадины
const int terrain_H_COUNT          = 2 ;  // кол-во высот (0,1)
/////////////
...
struct s_terrain
{
  int dheight ;      // изменение типа местности
  int type ;         // тип местности
  int x_frame,y_frame ;
  int h ;            // высота
} ;
//---------------------------------------------------------------------------
