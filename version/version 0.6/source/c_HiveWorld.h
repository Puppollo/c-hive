...
/*  for(int p=0;p<player_count;p++)
  {
    if(player[p].constructing_list[0][0]!=building_type_NO)
    {
      player[p].constructing_list[0][2]--;
      if(player[p].constructing_list[0][2]<=0)
      {
        player[p].constructing_list[0][1]-- ;
        if(player[p].constructing_list[0][1]<=0)
      } ;
    };
  } ;*/
