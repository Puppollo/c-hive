...
// building supply count font coord
const int font_NODE_COUNT_X      = 204 ;
const int font_NODE_COUNT_Y      = 406 ;
const int font_MINE_COUNT_X      = 230 ;
const int font_MINE_COUNT_Y      = 406 ;
const int font_FACTORY_COUNT_X   = 256 ;
const int font_FACTORY_COUNT_Y   = 406 ;
const int font_POWER_COUNT_X     = 282 ;
const int font_POWER_COUNT_Y     = 406 ;
const int font_SPEED_COUNT_X     = 308 ;
const int font_SPEED_COUNT_Y     = 406 ;
const int font_CHARGE_COUNT_X    = 334 ;
const int font_CHARGE_COUNT_Y    = 406 ;
const int font_SEPARATOR_COUNT_X = 360 ;
const int font_SEPARATOR_COUNT_Y = 406 ;
// building combat count font coord
const int font_IMPACTOR_COUNT_X = 204 ;
const int font_IMPACTOR_COUNT_Y = 444 ;
//... more combat building
// action
...
const int action_SHOW_GRID        = 4 ; // показать сетку
const int action_BUILD_NEXT       = 5 ; // нажатие на кнопку след. здание
const int action_BUILD_PREV       = 6 ; // нажатие на кнопку перд. здание
const int action_BUILD_NODE       = 7 ; // строить маяк
const int action_BUILD_FACTORY    = 8 ; // строить завод
const int action_BUILD_MINE       = 9 ; // строить шахту
const int action_BUILD_CHARGE     =10 ; // строить зарядку
const int action_BUILD_SPEED      =11 ; // строить ускоритель
const int action_BUILD_POWER      =12 ; // строить энергостанцию
const int action_BUILD_SEPARATOR  =13 ; // строить разделитель
const int action_BUILDING_ENABLE  =14 ; // вкл/выкл здание
const int action_DIRECTION_FOR_EMPTY  = 15 ; // направлять epmty
const int action_DIRECTION_FOR_MINERAL= 16 ; // направлять mineral
const int action_DIRECTION_FOR_ENERGY = 17 ; // направлять energy
const int action_SET_DIRECTION_U   = 18 ; //
const int action_SET_DIRECTION_UR  = 19 ; //
const int action_SET_DIRECTION_R   = 20 ; //
const int action_SET_DIRECTION_DR  = 21 ; //
const int action_SET_DIRECTION_D   = 22 ; //
const int action_SET_DIRECTION_DL  = 23 ; //
const int action_SET_DIRECTION_L   = 24 ; //
const int action_SET_DIRECTION_UL  = 25 ; //
const int action_SEPARATOR_CHANGE_DIRECTION = 26 ; // поменять направление разделителя
...
// build suplly building coord
const int emtBuildNode_X      = 194 ;
const int emtBuildNode_Y      = 417 ;
const int emtBuildMine_X      = 220 ;
const int emtBuildMine_Y      = 417 ;
const int emtBuildFactory_X   = 246 ;
const int emtBuildFactory_Y   = 417 ;
const int emtBuildPower_X     = 272 ;
const int emtBuildPower_Y     = 417 ;
const int emtBuildSpeed_X     = 298 ;
const int emtBuildSpeed_Y     = 417 ;
const int emtBuildCharge_X    = 324 ;
const int emtBuildCharge_Y    = 417 ;
const int emtBuildSeparator_X = 350 ;
const int emtBuildSeparator_Y = 417 ;
//build supply building frame coord
...
const int emtBuildSeparator_FRAME_X =6 ;
const int emtBuildSeparator_FRAME_Y =0 ;
//build combat building coord
const int emtBuildImpactor_X = 194 ;
const int emtBuildImpactor_Y = 456 ;
//... more combat building
//build combat building frame coord
const int emtBuildImpactor_FRAME_X = 0 ;
const int emtBuildImpactor_FRAME_Y = 4 ;
//... more combat building
//bilding buttons
...
const int emtShowTerritory_X = 144 ;
const int emtShowTerritory_Y = 4 ;
const int emtShowTerritory_FRAME_X = 3 ;
const int emtShowTerritory_FRAME_Y = 2 ;

const int emtShowGrid_X = 120 ;
const int emtShowGrid_Y = 4 ;
const int emtShowGrid_FRAME_X = 9 ;
const int emtShowGrid_FRAME_Y = 2 ;
...
const int emtSeparatorChangeDirection_X = 120 ;
const int emtSeparatorChangeDirection_Y = 4 ;
const int emtSeparatorChangeDirection_FRAME_X = 0 ;
const int emtSeparatorChangeDirection_FRAME_Y = 2 ;
//...
//---------------------------------------------------------------------------
void DummyFunction(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ; // пустышка
//direction set buttons
...
void OnBuildSeparator_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ;
//combat building build
void OnBuildImpactor_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ;
//other
...
void OnShowGrid_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ;

void OnBuildingEnable_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ; // вкл/выкл здание

void OnSeparatorChangeDirection_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element) ;
//... more function
//---------------------------------------------------------------------------
...
class c_HiveElements
{
  private :
    ...
    c_Element *emtBuildingSetDirectionU,
              ...
              *emtBuildPower,
              *emtBuildSeparator,
              //build combat building buttons
              *emtBuildImpactor,

              //other
              *emtSeparatorChangeDirection,
...
//---------------------------------------------------------------------------
c_HiveElements::c_HiveElements(c_World *w,s_mouse *m,c_Sprite *s,int cpx,int cpy,
...
///////////////////////////////////////
//SUPPLY BUILDING
  emtBuildNode      = new c_Element(sprite,emtBuildNode_X,emtBuildNode_Y,0,0,
                                    emtBuildNode_FRAME_X,emtBuildNode_FRAME_Y,
                                    &OnBuildNode_click,&DummyFunction,log_file);
  emtBuildFactory   = new c_Element(sprite,emtBuildFactory_X,emtBuildFactory_Y,0,0,
                                    emtBuildFactory_FRAME_X,emtBuildFactory_FRAME_Y,
                                    &OnBuildFactory_click,&DummyFunction,log_file);
  emtBuildMine      = new c_Element(sprite,emtBuildMine_X,emtBuildMine_Y,0,0,
                                    emtBuildMine_FRAME_X,emtBuildMine_FRAME_Y,
                                    &OnBuildMine_click,&DummyFunction,log_file);
  emtBuildCharge    = new c_Element(sprite,emtBuildCharge_X,emtBuildCharge_Y,0,0,
                                    emtBuildCharge_FRAME_X,emtBuildCharge_FRAME_Y,
                                    &OnBuildCharge_click,&DummyFunction,log_file);
  emtBuildSpeed     = new c_Element(sprite,emtBuildSpeed_X,emtBuildSpeed_Y,0,0,
                                    emtBuildSpeed_FRAME_X,emtBuildSpeed_FRAME_Y,
                                    &OnBuildSpeed_click,&DummyFunction,log_file);
  emtBuildPower     = new c_Element(sprite,emtBuildPower_X,emtBuildPower_Y,0,0,
                                    emtBuildPower_FRAME_X,emtBuildPower_FRAME_Y,
                                    &OnBuildPower_click,&DummyFunction,log_file);
  emtBuildSeparator = new c_Element(sprite,emtBuildSeparator_X,emtBuildSeparator_Y,0,0,
                                    emtBuildSeparator_FRAME_X,emtBuildSeparator_FRAME_Y,
                                    &OnBuildSeparator_click,&DummyFunction,log_file) ;
///////////////////////////////////////
//COMBAT BUILDING
  emtBuildImpactor = new c_Element(sprite,emtBuildImpactor_X,emtBuildImpactor_Y,0,0,
                                   emtBuildImpactor_FRAME_X,emtBuildImpactor_FRAME_Y,
                                   &OnBuildImpactor_click,&DummyFunction,log_file) ;
///////////////////////////////////////
...
///////////////////////////////////////
  emtShowGrid = new c_Element(sprite,emtShowGrid_X+common_panel_x,emtShowGrid_Y+common_panel_y,
                              0,0,emtShowGrid_FRAME_X,emtShowGrid_FRAME_Y,
                              &OnShowGrid_click,&DummyFunction,log_file) ;
  emtShowGrid->SetElementSize(12,12) ;
///////////////////////////////////////
...
///////////////////////////////////////
  emtSeparatorChangeDirection = new c_Element(sprite,emtSeparatorChangeDirection_X+common_panel_x,
                                              emtSeparatorChangeDirection_Y+common_panel_y,0,0,
                                              emtSeparatorChangeDirection_FRAME_X,emtSeparatorChangeDirection_FRAME_Y,
                                              &OnSeparatorChangeDirection_click,&DummyFunction,log_file) ;
  emtSeparatorChangeDirection->SetElementSize(12,12) ;
} ;
//---------------------------------------------------------------------------
void c_HiveElements::Release(FILE *log_file)
{
  ...
  delete emtBuildSeparator ;

  delete emtBuildImpactor;
  ...
  delete emtSeparatorChangeDirection ;
  //...
...
void c_HiveElements::Turn(char key,FILE *log_file)
{
  ...
  emtBuildSeparator->CheckState(mouse,world,action,player_ID) ;

  emtBuildImpactor->CheckState(mouse,world,action,player_ID) ;
  ...
  switch(common_screen_panel)
  {
    case screen_panel_COMMON_BUILDING :
      ...
      { // check special buildings buttons
        ...
        switch((world->building[x][y]).type)
        {
          ...
          break;
          case building_type_SEPARATOR :
            emtDestroyBuilding->CheckState(mouse,world,action,player_ID) ;
            emtBuildingEnable->CheckState(mouse,world,action,player_ID) ;
            emtDirectionForEmpty->CheckState(mouse,world,action,player_ID) ;
            emtDirectionForMineral->CheckState(mouse,world,action,player_ID) ;
            emtDirectionForEnergy->CheckState(mouse,world,action,player_ID) ;
            emtSeparatorChangeDirection->CheckState(mouse,world,action,player_ID) ;
          break;
        } ;
      };
      //...
    ...
    case screen_panel_COMMON_NO :
      ...
      emtShowGrid->CheckState(mouse,world,action,player_ID) ;
      //...
    break;
  } ;
  //...
...
HRESULT c_HiveElements::Draw(RECT screen,IDirectDrawSurface *DDSSurface,FILE *log_file)
{
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_NODE],
                 font_NODE_COUNT_X,font_NODE_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_FACTORY],
                 font_FACTORY_COUNT_X,font_FACTORY_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_MINE],
                 font_MINE_COUNT_X,font_MINE_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_CHARGE],
                 font_CHARGE_COUNT_X,font_CHARGE_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_SPEED],
                 font_SPEED_COUNT_X,font_SPEED_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  ...
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_POWER],
                 font_POWER_COUNT_X,font_POWER_COUNT_Y,2) ;
  if(res!=DD_OK)return res;
  res=emtBuildSeparator->Draw(DDSSurface,log_file) ;
  if(res!=DD_OK)return res;
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_count[player_buildings_SEPARATOR],
                 font_SEPARATOR_COUNT_X,font_SEPARATOR_COUNT_Y,2) ;
  if(res!=DD_OK)return res;

  res=emtBuildImpactor->Draw(DDSSurface,log_file) ;
  if(res!=DD_OK)return res;
  res=font->Draw(DDSSurface,(world->player[player_ID]).buildings_combat_count[player_buildings_combat_IMPACTOR],
                 font_IMPACTOR_COUNT_X,font_IMPACTOR_COUNT_Y,2) ;

  switch(common_screen_panel)
  {
    case screen_panel_COMMON_NO :
      res=emtShowGrid->Draw(DDSSurface,log_file) ;
      if(res!=DD_OK)return res;
    ...
    case screen_panel_COMMON_BUILDING :
    {
      ...
      switch((world->building[x][y]).type)
      {
        ...
        case building_type_BASE :
          ...
          if(res!=DD_OK)return res;
          //draw resurce count
          res=font->Draw(DDSSurface,"M",1,font_common_MRL_X+common_panel_x,font_common_MRL_Y+common_panel_y,2);
          if(res!=DD_OK)return res;
          res=font->Draw(DDSSurface,"E",1,font_common_ENY_X+common_panel_x,font_common_ENY_Y+common_panel_y,2);
          if(res!=DD_OK)return res;
        ...
        case building_type_SEPARATOR :
          //draw title
          res=font->Draw(DDSSurface,"Separator",9,font_common_title_X+common_panel_x,font_common_title_Y+common_panel_y,2) ;
          if(res!=DD_OK)return res;
          //draw special
          if((world->building[x][y]).param[3]==0) emtDirectionForEmpty->SetFrameY(emtDirectionForEmpty_FRAME_Y+1) ;
          else                                    emtDirectionForEmpty->SetFrameY(emtDirectionForEmpty_FRAME_Y) ;
          ...
          if((world->building[x][y]).y_frame==building_y_frame_SEPARATOR_VERTICAL)
            emtSeparatorChangeDirection->SetFrameY(emtSeparatorChangeDirection_FRAME_Y) ;
          else
            emtSeparatorChangeDirection->SetFrameY(emtSeparatorChangeDirection_FRAME_Y+1) ;
          res=emtSeparatorChangeDirection->DrawClip(screen,DDSSurface,log_file) ;
          if(res!=DD_OK)return res;
          //other
          res=emtDestroyBuilding->Draw(DDSSurface,log_file) ;
          if(res!=DD_OK)return res;
...
void c_HiveElements::CheckAction(FILE *log_file)
{
  if(mouse->button==mouse_button_RIGHT)
  {
    ...
    emtBuildImpactor->SetFrameY(emtBuildImpactor_FRAME_Y) ;
    return ;
  } ;
  switch(action)
  {
    ...
    case action_DESTROY_BUILDING : // уничтожить здание
      ...
      common_screen_panel = screen_panel_COMMON_NO ;
      {
        //убрать здание
        int x=param[0],y=param[1];
        (world->building[x][y]).type = building_type_BLOW ;
    ...
    case action_SHOW_GRID :
      action = action_NO;
      if((world->player[player_ID]).show_grid==0) (world->player[player_ID]).show_grid=1;
      else                                        (world->player[player_ID]).show_grid=0;
    ...
    break;
    case action_SEPARATOR_CHANGE_DIRECTION :
    {
      action=action_NO ;
      int x=param[0],y=param[1];
      if((world->building[x][y]).y_frame==building_y_frame_SEPARATOR_HORIZONTAL)
        (world->building[x][y]).y_frame=building_y_frame_SEPARATOR_VERTICAL ;
      else
        (world->building[x][y]).y_frame=building_y_frame_SEPARATOR_HORIZONTAL ;
    } ;
    break;
  ...
  if(mouse->button==mouse_button_LEFT&&mouse->y_frame==building_y_frame_GOODPLACE)
  {
    switch(action)
    {
      ...
      case action_BUILD_POWER :     // начать строительство электростанции
        ...
        (world->building[mouse->cell_x][mouse->cell_y]).enable=1;
      break;
      case action_BUILD_SEPARATOR :
        action=action_NO ;
        emtBuildSeparator->SetFrameY(emtBuildSeparator_FRAME_Y) ;
        mouse->x_frame = building_type_SELECT ;
        (world->building[mouse->cell_x][mouse->cell_y]).type=building_type_CONSTRUCTING ;
        (world->building[mouse->cell_x][mouse->cell_y]).y_frame=0 ;
        (world->building[mouse->cell_x][mouse->cell_y]).r=0;
        (world->building[mouse->cell_x][mouse->cell_y]).HP = building_SEPARATOR_HP ;
        (world->building[mouse->cell_x][mouse->cell_y]).maxHP = building_SEPARATOR_HP ;
        (world->building[mouse->cell_x][mouse->cell_y]).param[0]=building_type_SEPARATOR ;
        (world->building[mouse->cell_x][mouse->cell_y]).param[1]=building_SEPARATOR_BUILD_TIME ;
        (world->building[mouse->cell_x][mouse->cell_y]).param[2]=building_exit_coord_X ;
        (world->building[mouse->cell_x][mouse->cell_y]).param[3]=building_exit_coord_Y ;
        (world->building[mouse->cell_x][mouse->cell_y]).owner=player_ID;
        (world->building[mouse->cell_x][mouse->cell_y]).enable=1;
...
void OnBuildSeparator_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element)
{
  if((world->player[player_ID]).buildings_count[player_buildings_SEPARATOR]>0)//проверка на наличие прототипа здания
  {
    (world->player[player_ID]).buildings_count[player_buildings_SEPARATOR]--;
    action=action_BUILD_SEPARATOR ;
    mouse->x_frame=building_type_BUILDPLACE ;
    element->SetFrameY(emtBuildPower_FRAME_Y+1) ;
  } ;
} ;
...
void OnShowGrid_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element)
{
  action = action_SHOW_GRID ;
  if(element->GetFrameY()==emtShowGrid_FRAME_Y) element->SetFrameY(emtShowGrid_FRAME_Y+1) ;
  else                                          element->SetFrameY(emtShowGrid_FRAME_Y) ;
} ;
//---------------------------------------------------------------------------
...
void OnSeparatorChangeDirection_click(s_mouse *mouse,c_World *world,int &action,int player_ID,c_Element *element)
{
  action = action_SEPARATOR_CHANGE_DIRECTION ;
} ;
//---------------------------------------------------------------------------
#endif
