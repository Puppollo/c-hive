...
const int sprite_BUILDINGS_X_COUNT  =15 ;
...
void GameMain()
{
  ...
  CheckError(res,"font->Draw") ;
  res=font_info->Draw(DDraw->DDSBack,"h",1,font_info_Htxt_X,font_info_Htxt_Y,1) ;
  CheckError(res,"font->Draw") ;
  res=font_info->Draw(DDraw->DDSBack,((world->building[mouse.cell_x][mouse.cell_y]).terrain.height),font_info_H_X,font_info_H_Y,1) ;
  CheckError(res,"font->Draw") ;
  //supply text out
