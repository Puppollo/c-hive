...
const int action_BUILDING_ENABLE  =13 ; // вкл/выкл здание
const int action_DIRECTION_FOR_EMPTY  = 14 ; // направлять epmty
const int action_DIRECTION_FOR_MINERAL= 15 ; // направлять mineral
const int action_DIRECTION_FOR_ENERGY = 16 ; // направлять energy
const int action_SET_DIRECTION_U   = 17 ; //
const int action_SET_DIRECTION_UR  = 18 ; //
const int action_SET_DIRECTION_R   = 19 ; //
const int action_SET_DIRECTION_DR  = 20 ; //
const int action_SET_DIRECTION_D   = 21 ; //
const int action_SET_DIRECTION_DL  = 22 ; //
const int action_SET_DIRECTION_L   = 23 ; //
const int action_SET_DIRECTION_UL  = 24 ; //
