...
void GenMineral      (s_building building[world_X_COUNT][world_Y_COUNT],int landscape[world_X_COUNT][world_Y_COUNT]) ; // сгенерировать минералы
void MineralExtend   (s_building building[world_X_COUNT][world_Y_COUNT]) ; // расширение минеральных жил
void SelectFrame     (s_building building[world_X_COUNT][world_Y_COUNT],int landscape[world_X_COUNT][world_Y_COUNT],int H=1) ; // выбрать соответсвующий кадр для клетки ландшафта
...
//---------------------------------------------------------------------------
void SelectFrame(s_building building[world_X_COUNT][world_Y_COUNT],int landscape[world_X_COUNT][world_Y_COUNT],int H)
{
