...
const int sprite_BUILDINGS_COUNT = 6 ;
//---------------------------------------------------------------------------
//SYSTEM---------------------------------------------------------------------
...
void GameInit()
{
  ...
  SpriteList->Add(DDraw->DDraw,"art\\buildings.bmp",sprite_BUILDINGS_COUNT,3,log_file) ;
  ...
  (world->building[3][3]).type = building_type_FACTORY ;
  (world->building[4][3]).type = building_type_FACTORY;
  (world->building[3][4]).type = building_type_FACTORY ;
