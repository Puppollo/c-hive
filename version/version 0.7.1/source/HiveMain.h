...
const int building_terrain_MAX_DHEIGHT = 100 ; // величина dheight необходимая для начала изменения высоты
/////////////
...
const int world_CYCLE_MINERAL = 1 ;     // цикл во время которого образуются новые жилы
/////////////
