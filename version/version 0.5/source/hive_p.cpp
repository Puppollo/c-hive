...
const int sprite_BUILDINGS_X_COUNT  =12 ;
const int sprite_BUILDINGS_Y_COUNT  = 4 ;
const int sprite_PARTICICLE_X_COUNT = 5 ;
const int sprite_PARTICICLE_Y_COUNT = 3 ;
const int sprite_BUTTONS_X_COUNT    = 9 ;
const int sprite_BUTTONS_Y_COUNT    = 4 ;
const int sprite_PANELS_X_COUNT     = 4 ;
...
void GameInit()
{
  ...
  (world->player[player_ID]).show_grid=1;

  world->SetBuilding(100,100,building_type_MAIN,0) ;
  world->SetBuilding(105,105,building_type_BASE,player_ID) ;
  world->SetBuilding(107,107,building_type_MINERAL,0) ;

  s_ParticicleInfo PInfo ;
  PInfo.TurnTime = 1 ;
  PInfo.GenerateTime = 100 ;
...
void GameMain()
{
  ...
  CheckError(res,"panels->Draw") ;
  res=panels->Draw(DDraw->DDSBack,common_panel_X+128,common_panel_Y,3,0) ;
  CheckError(res,"panels->Draw") ;
  res=HiveElements->Draw(screen,DDraw->DDSBack) ;
